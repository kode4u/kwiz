...
For the Code Executability dimension, the panel achieved an $\text{ICC}(2,k)$ of 0.334, indicating fair-to-moderate inter-rater agreement between frontier LLM judges and expert validation. Technical Correctness attained a high mean rating of 4.49 ± 1.14, Pedagogical Relevance reached 4.85 ± 0.44, and Code Executability achieved 4.90 ± 0.54, confirming strong technical accuracy and curricular alignment. Context Groundedness reached 4.66 ± 0.69, demonstrating that generated questions adhere strictly to the retrieved course slide excerpts.
...
3. **Pedagogical Evaluation Scope:**
   Our evaluation establishes high multi-judge correctness (4.49/5.0), distractor plausibility (4.29/5.0), pedagogical relevance (4.85/5.0), and 86.0% aggregate pedagogical acceptability with moderate code executability agreement ($\text{ICC} = 0.334$). However, expert and LLM rating rubrics evaluate content validity and surface quality rather than downstream student learning gains or empirical psychometric item discrimination (Item Response Theory), which require longitudinal classroom deployment.
...
- **86.0% of generated MCQs** were classified by the multi-judge panel as pedagogically acceptable (78.0% accept as-is, 8.0% with minor revision; 4.49/5.0 technical correctness, 4.85/5.0 pedagogical relevance, and 4.90/5.0 code executability), with frontier LLM judges exhibiting discriminative sensitivity to nuanced logic traps while deterministic AST compilation verified code syntax.
