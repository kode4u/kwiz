...
$string['learning_outcomes_help'] = 'Target learning outcomes for question generation (e.g., understand loops, recursion)';
$string['learning_outcomes_preset'] = 'Load outcome from course label/outcome';
$string['choose_preset_outcome'] = 'Choose a label or outcome from the course...';
...
$string['lesson_content'] = 'Lesson content';
$string['lesson_content_placeholder'] = 'Paste your lesson notes, slides text, or reading material here…';
$string['lesson_content_help'] = 'When provided, the AI will create multiple-choice questions based on this lesson. Leave empty to generate from the topic only.';
$string['generation_queued'] = 'Question generation has been queued. You can continue using the page while it runs in the background.';
$string['generation_sent'] = 'Request sent to the LLM service. Questions will appear when processing completes.';
$string['generation_in_progress'] = 'Generating questions in the background…';
$string['generation_progress'] = 'Generated {$a->completed} of {$a->total} categories…';
$string['generation_failed'] = 'Question generation failed. Please check your LLM configuration and try again.';
$string['generation_status_queued'] = 'Queued';
$string['generation_status_sent'] = 'Sent to LLM';
$string['generation_status_processing'] = 'LLM processing';
$string['generation_status_success'] = 'Complete';
$string['generation_status_error'] = 'Failed';
...
$string['background_bg'] = 'Background {$a}';
$string['background_predefined'] = 'Predefined background';
$string['background_preview'] = 'Preview';
