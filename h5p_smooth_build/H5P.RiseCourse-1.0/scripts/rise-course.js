...
H5P.RiseCourse = (function ($, EventDispatcher) {
  ...
  function RiseCourse(params, contentId, contentData) {
    ...
    self.enhanceContentBlocks = function ($container) {
      ...
      $lists.each(function () {
        var $list = $(this);
        // Exclude all quiz options, answers, scorebars, navigation, sidebar, and special widgets
        if ($list.is(".h5p-sc-alternatives, .h5p-answers, .h5p-question-answers, .h5p-choices, .h5p-summary-list, .rise-lesson-list, .rise-course-sections, .rise-sidebar-lesson-list, .rise-sidebar-nav, .h5p-image-slider-progress, .h5p-dragnbar-ul, .h5p-joubelui-score-bar")) return;
        if ($list.closest(".h5p-multichoice, .h5p-single-choice-set, .h5p-true-false, .h5p-question, .h5p-summary-list, .ui-autocomplete, .rise-course-sections, .rise-lesson-list, .rise-sidebar, .rise-sidebar-nav, .rise-sidebar-lesson-list, .rise-visual-outline-sidebar, .rise-outline-tree, .h5p-image-slider-progress, .rise-code-dots, .h5p-audio-inner, .h5p-ba-navigation, .h5p-dialogcards, .h5p-drag-text").length) return;
